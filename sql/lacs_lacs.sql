...
--
-- Host: localhost
-- Generation Time: Feb 25, 2026 at 04:00 PM
...
INSERT INTO `agendas` (`agenda_id`, `session_id`, `agenda_title`, `agenda_description`, `status`, `created_at`) VALUES
(31, 64, 'DRAFTING OF O-1326-2026', 'Session on the Extension of the Deadline for the Renewal of Business Taxes, Fees, and Charges (O-1326-2026).', 'Draft', '2026-02-25 14:48:18');
...
INSERT INTO `agenda_items` (`agenda_item_id`, `agenda_id`, `session_id`, `item_title`, `item_purpose`, `item_description`, `item_recommendation`, `action_type`, `deadline`, `assigned_to`, `created_by`, `status`, `priority`, `created_at`, `completed_at`, `order_index`, `action_type_id`, `revision_remarks`) VALUES
(11, 31, 64, 'O-1326-2026', 'Extension of the Deadline for the Renewal of Business Taxes, Fees, and Charges.', 'DOCUMENT', 'For approval', 'For Action', '2026-02-25 00:00:00', 14, 1, 'Completed', 'Medium', '2026-02-25 14:48:18', '2026-02-25 15:17:28', 0, NULL, NULL);
...
--
-- Dumping data for table `agenda_item_documents`
--

INSERT INTO `agenda_item_documents` (`document_id`, `agenda_item_id`, `file_name`, `file_type`, `file_path`, `uploaded_by`, `uploaded_at`) VALUES
(8, 11, 'R-3724-2026.pdf', 'pdf', '../uploads/agenda_documents/1772031015_R-3724-2026.pdf', 1, '2026-02-25 14:50:15');
...
CREATE TABLE `ai_documents` (
  ...
  `manual_classification` varchar(100) DEFAULT NULL,
...
INSERT INTO `deadlines` (`deadline_id`, `title`, `description`, `due_date`, `priority`, `status`, `assigned_to`, `created_by`, `created_at`, `updated_at`) VALUES
(15, 'O-1326-2026', 'DOCUMENT\n\n(Linked to Agenda Item ID: 11)', '2026-02-25 00:00:00', 'Medium', 'Completed', 14, NULL, '2026-02-25 14:48:18', '2026-02-25 15:17:28');
...
(2, 2, 'session_reminder', 'Reminder: Session \'TEST: 23h Away (Start in 23 h)\' starts in 24 hours (January 22, 2026 6:18 AM).', '/admin/sessions/38', 0, '2026-01-21 06:19:14'),
(3, 2, 'session_reminder', 'Reminder: Session \'TEST: 23h Away (Start in 23 h)\' starts in 24 hours (January 22, 2026 1:24 PM).', '/admin/sessions/42', 0, '2026-01-21 06:25:08'),
(4, 2, 'session_reminder', 'Urgent: Session \'TEST: 45m Away (Start in 0.75 h)\' starts in 1 hour (January 21, 2026 3:09 PM).', '/admin/sessions/43', 0, '2026-01-21 06:25:08'),
(5, 2, 'session_reminder', 'Reminder: Session \'FIX TEST 24H\' starts in 24 hours (January 22, 2026 1:54 PM).', '/admin/sessions/47', 0, '2026-01-21 06:54:20'),
(6, 2, 'session_reminder', 'Reminder: Session \'FIX TEST 24H\' starts in 24 hours (January 22, 2026 1:54 PM).', '/admin/sessions/48', 0, '2026-01-21 06:54:44'),
(7, 2, 'session_reminder', 'Urgent: Session \'TEST: 2h Away (Start in 2 h)\' starts in 1 hour (January 21, 2026 4:24 PM).', '/admin/sessions/45', 0, '2026-01-21 07:15:51'),
(8, 2, 'manual_staff_reminder', 'Manual Reminder: Session \'TEST: 23h Away (Start in 23 h)\' is scheduled for January 22, 2026. Please prepare accordingly.', '/admin/sessions/38', 0, '2026-01-21 23:01:13'),
(9, 2, 'manual_staff_reminder', 'Manual Reminder: Session \'TEST: 26h Away (Start in 26 h)\' is scheduled for January 22, 2026. Please prepare accordingly.', '/admin/sessions/40', 0, '2026-01-21 23:01:13'),
(10, 2, 'manual_staff_reminder', 'Manual Reminder: Session \'TEST: 23h Away (Start in 23 h)\' is scheduled for January 22, 2026. Please prepare accordingly.', '/admin/sessions/42', 0, '2026-01-21 23:01:13'),
(11, 2, 'manual_staff_reminder', 'Manual Reminder: Session \'TEST: 26h Away (Start in 26 h)\' is scheduled for January 22, 2026. Please prepare accordingly.', '/admin/sessions/44', 0, '2026-01-21 23:01:13'),
(12, 2, 'manual_staff_reminder', 'Manual Reminder: Session \'FIX TEST 24H\' is scheduled for January 22, 2026. Please prepare accordingly.', '/admin/sessions/47', 0, '2026-01-21 23:01:13'),
(13, 11, 'Agenda Item Status', 'Revision requested for your agenda item \'test agenda item 2\'. Please check the remarks.', 'agendas', 1, '2026-02-22 20:33:37'),
(14, 11, 'Agenda Item Status', 'Revision requested for your agenda item \'test agenda item 2\'. Please check the remarks.', 'agendas', 1, '2026-02-22 20:40:30'),
(15, 11, 'Agenda Item Status', 'Revision requested for your agenda item \'test agenda item 2\'. Please check the remarks.', 'agendas', 1, '2026-02-22 20:47:27'),
(16, 11, 'Agenda Item Status', 'Your agenda item \'test agenda item 2\' has been approved and marked as completed.', 'agendas', 1, '2026-02-22 20:47:59'),
(21, 1, 'SystemRead', 's_inc_60', NULL, 1, '2026-02-24 14:35:29'),
(22, 14, 'Agenda Item Status', 'Your agenda item \'O-1326-2026\' has been approved and marked as completed.', 'agendas', 0, '2026-02-25 15:17:28');
...
--
-- Dumping data for table `reminder_batches`
--

INSERT INTO `reminder_batches` (`batch_id`, `created_by`, `title`, `message`, `related_type`, `related_id`, `target_roles`, `reminder_date`, `status`, `created_at`, `admin_deleted`) VALUES
(50, 1, 'system maintenance', 'system maintenance', 'System', 0, 'Administrator,Staff,User', '2026-02-23 00:00:00', 'Sent', '2026-02-22 15:00:52', 1),
(51, 1, 'system maintenance', 'system maintenance', 'System', 0, 'Administrator,Staff,User', '2026-02-22 23:01:18', 'Sent', '2026-02-22 15:01:18', 1),
(52, 1, 'system maintenance', 'system maintenance', 'System', 0, 'Administrator,Staff,User', '2026-02-22 23:01:46', 'Sent', '2026-02-22 15:01:46', 1),
(53, 1, 'maintenance', 'maintenance', 'System', 0, 'Administrator,Staff,User', '2026-02-22 23:30:00', 'Sent', '2026-02-22 15:12:49', 1),
(54, 1, 'test', 'test', 'Other', 0, 'Administrator,Staff,User', '2026-02-22 23:20:00', 'Sent', '2026-02-22 15:19:17', 1),
(55, 1, 'test', 'test', 'Other', 0, 'Administrator,Staff,User', '2026-02-22 23:21:21', 'Sent', '2026-02-22 15:21:21', 1),
(56, 1, 'test 1', 'test', 'System', 0, 'Administrator,Staff,User', '2026-02-22 23:33:00', 'Sent', '2026-02-22 15:32:09', 1),
(57, 1, 'test 1', 'test', 'System', 0, 'Administrator,Staff,User', '2026-02-22 23:32:12', 'Sent', '2026-02-22 15:32:12', 1),
(64, 1, '13th Sangguniang Panlungsod of Valenzuela City 1st Emergency Session – CY 2026', 'Upcoming session: 13th Sangguniang Panlungsod of Valenzuela City 1st Emergency Session – CY 2026 scheduled for Feb 25, 2026 at 10:00 AM.', 'Session', 64, 'Administrator,Staff', '2026-02-25 10:00:00', 'Scheduled', '2026-02-25 13:22:10', 0),
(65, 1, '13th Sangguniang Panlungsod of Valenzuela City 1st Emergency Session – CY 2026', 'Session has been rescheduled.\n\nSession: 13th Sangguniang Panlungsod of Valenzuela City 1st Emergency Session – CY 2026\nPrevious: Feb 25, 2026 10:00 AM\nNew: Feb 27, 2026 10:00 AM', 'Session', 64, 'Administrator,Staff', '2026-02-25 13:23:28', 'Sent', '2026-02-25 13:23:28', 0),
(67, 1, '13th Sangguniang Panlungsod of Valenzuela City 1st Regular Session – CY 2026', 'Upcoming session: 13th Sangguniang Panlungsod of Valenzuela City 1st Regular Session – CY 2026 scheduled for Mar 01, 2026 at 10:00 AM.', 'Session', 66, 'Administrator,Staff', '2026-03-01 10:00:00', 'Scheduled', '2026-02-25 13:26:59', 0),
(68, 1, '13th Sangguniang Panlungsod of Valenzuela City 2nd Emergency Session – CY 2026', 'Upcoming session: 13th Sangguniang Panlungsod of Valenzuela City 2nd Emergency Session – CY 2026 scheduled for Mar 12, 2026 at 1:00 PM.', 'Session', 67, 'Administrator,Staff', '2026-03-12 13:00:00', 'Scheduled', '2026-02-25 13:31:30', 0),
(69, 1, '13th Sangguniang Panlungsod of Valenzuela City 2nd Regular Session – CY 2026', 'Upcoming session: 13th Sangguniang Panlungsod of Valenzuela City 2nd Regular Session – CY 2026 scheduled for Mar 11, 2026 at 8:00 AM.', 'Session', 68, 'Administrator,Staff', '2026-03-11 08:00:00', 'Scheduled', '2026-02-25 13:33:28', 0),
(70, 1, '13th Sangguniang Panlungsod of Valenzuela City 2nd Emergency Session – CY 2026', 'Upcoming session: 13th Sangguniang Panlungsod of Valenzuela City 2nd Emergency Session – CY 2026 scheduled for Feb 26, 2026 at 2:00 PM.', 'Session', 69, 'Administrator,Staff', '2026-02-26 14:00:00', 'Scheduled', '2026-02-25 13:38:04', 0),
(71, 1, '13th Sangguniang Panlungsod of Valenzuela City 1st Special Session – CY 2026', 'Upcoming session: 13th Sangguniang Panlungsod of Valenzuela City 1st Special Session – CY 2026 scheduled for Mar 03, 2026 at 8:00 AM.', 'Session', 70, 'Administrator,Staff', '2026-03-03 08:00:00', 'Scheduled', '2026-02-25 13:39:46', 0),
(72, 1, '13th Sangguniang Panlungsod of Valenzuela City 3rd Regular Session – CY 2026', 'Upcoming session: 13th Sangguniang Panlungsod of Valenzuela City 3rd Regular Session – CY 2026 scheduled for Mar 05, 2026 at 10:00 PM.', 'Session', 71, 'Administrator,Staff', '2026-03-05 22:00:00', 'Scheduled', '2026-02-25 13:42:06', 0);
...
INSERT INTO `reminder_recipients` (`recipient_id`, `batch_id`, `user_id`, `status`, `read_at`) VALUES
(225, 50, 2, 'Pending', NULL),
(226, 50, 3, 'Pending', NULL),
(228, 50, 10, 'Read', '2026-02-22 23:47:59'),
(229, 50, 11, 'Read', '2026-02-22 23:31:10'),
(232, 51, 2, 'Pending', NULL),
(233, 51, 3, 'Pending', NULL),
(235, 51, 10, 'Read', '2026-02-22 23:47:59'),
(236, 51, 11, 'Read', '2026-02-22 23:31:10'),
(239, 52, 2, 'Pending', NULL),
(240, 52, 3, 'Pending', NULL),
(242, 52, 10, 'Read', '2026-02-22 23:47:59'),
(243, 52, 11, 'Read', '2026-02-22 23:01:57'),
(246, 53, 2, 'Pending', NULL),
(247, 53, 3, 'Pending', NULL),
(249, 53, 10, 'Read', '2026-02-22 23:47:59'),
(250, 53, 11, 'Read', '2026-02-22 23:31:10'),
(253, 54, 2, 'Pending', NULL),
(254, 54, 3, 'Pending', NULL),
(256, 54, 10, 'Read', '2026-02-22 23:47:59'),
(257, 54, 11, 'Read', '2026-02-22 23:31:10'),
(260, 55, 2, 'Pending', NULL),
(261, 55, 3, 'Pending', NULL),
(263, 55, 10, 'Read', '2026-02-22 23:47:59'),
(264, 55, 11, 'Read', '2026-02-22 23:31:10'),
(267, 56, 2, 'Pending', NULL),
(268, 56, 3, 'Pending', NULL),
(270, 56, 10, 'Read', '2026-02-22 23:47:59'),
(271, 56, 11, 'Read', '2026-02-23 04:34:04'),
(274, 57, 2, 'Pending', NULL),
(275, 57, 3, 'Pending', NULL),
(277, 57, 10, 'Read', '2026-02-22 23:47:59'),
(278, 57, 11, 'Read', '2026-02-23 04:34:04'),
(307, 64, 2, 'Pending', NULL),
(310, 65, 2, 'Pending', NULL),
(316, 67, 2, 'Pending', NULL),
(319, 68, 2, 'Pending', NULL),
(321, 69, 1, 'Pending', NULL),
(322, 69, 2, 'Pending', NULL),
(324, 70, 1, 'Pending', NULL),
(325, 70, 2, 'Pending', NULL),
(327, 71, 1, 'Pending', NULL),
(328, 71, 2, 'Pending', NULL),
(330, 72, 1, 'Pending', NULL),
(331, 72, 2, 'Pending', NULL);
...
INSERT INTO `sessions` (`session_id`, `title`, `session_type`, `session_date`, `actual_start_time`, `actual_end_time`, `venue`, `presiding_officer`, `status`, `created_at`, `created_by`, `session_status`, `cancellation_reason`, `venue_id`) VALUES
(64, '13th Sangguniang Panlungsod of Valenzuela City 1st Emergency Session – CY 2026', 'Emergency Session', '2026-02-27', '10:00:00', '15:00:00', 'Barangay Hall - Malinta', 'Hon. Marlon Alejandrino', 'Scheduled', '2026-02-25 13:22:10', 1, 'Active', NULL, 4),
(66, '13th Sangguniang Panlungsod of Valenzuela City 1st Regular Session – CY 2026', 'Regular Session', '2026-03-01', '10:00:00', '15:00:00', 'Conference Room A - City Hall Annex', 'Hon. Marlon Alejandrino', 'Scheduled', '2026-02-25 13:26:59', 1, 'Active', NULL, 2),
(67, '13th Sangguniang Panlungsod of Valenzuela City 2nd Emergency Session – CY 2026', 'Emergency Session', '2026-03-12', '13:00:00', '17:00:00', 'Barangay Hall - Marulas', 'Hon. Marlon Paulo C. Alejandrino', 'Scheduled', '2026-02-25 13:31:30', 1, 'Active', NULL, 6),
(68, '13th Sangguniang Panlungsod of Valenzuela City 2nd Regular Session – CY 2026', 'Regular Session', '2026-03-11', '08:00:00', '00:00:00', 'Barangay Hall - Marulas', 'Hon. Marlon Paulo C. Alejandrino', 'Scheduled', '2026-02-25 13:33:28', 1, 'Active', NULL, 6),
(69, '13th Sangguniang Panlungsod of Valenzuela City 2nd Emergency Session – CY 2026', 'Emergency Session', '2026-02-26', '14:00:00', '17:00:00', 'Barangay Hall - Karuhatan', 'Hon. Marlon Paulo C. Alejandrino', 'Scheduled', '2026-02-25 13:38:04', 1, 'Active', NULL, 5),
(70, '13th Sangguniang Panlungsod of Valenzuela City 1st Special Session – CY 2026', 'Special Session', '2026-03-03', '08:00:00', '12:00:00', 'Valenzuela Astrodome', 'Hon. Weslie T. Gatchalian', 'Scheduled', '2026-02-25 13:39:46', 1, 'Active', NULL, 3),
(71, '13th Sangguniang Panlungsod of Valenzuela City 3rd Regular Session – CY 2026', 'Regular Session', '2026-03-05', '22:00:00', '15:00:00', 'Sangguniang Panlungsod Session Hall', 'Hon. Marlon Paulo C. Alejandrino', 'Scheduled', '2026-02-25 13:42:06', 1, 'Active', NULL, 1);
...
--
-- Dumping data for table `session_assignments`
--

INSERT INTO `session_assignments` (`assignment_id`, `session_id`, `user_id`, `assigned_at`) VALUES
(117, 64, 18, '2026-02-25 13:22:10'),
(118, 64, 14, '2026-02-25 13:22:10'),
(119, 64, 12, '2026-02-25 13:22:10'),
(120, 64, 17, '2026-02-25 13:22:10'),
(127, 66, 14, '2026-02-25 13:26:59'),
(128, 66, 12, '2026-02-25 13:26:59'),
(129, 66, 17, '2026-02-25 13:26:59'),
(130, 66, 4, '2026-02-25 13:26:59'),
(131, 66, 19, '2026-02-25 13:26:59'),
(132, 66, 7, '2026-02-25 13:26:59'),
(133, 67, 18, '2026-02-25 13:31:30'),
(134, 67, 14, '2026-02-25 13:31:30'),
(135, 67, 16, '2026-02-25 13:31:30'),
(136, 67, 4, '2026-02-25 13:31:30'),
(137, 67, 19, '2026-02-25 13:31:30'),
(138, 68, 3, '2026-02-25 13:33:28'),
(139, 68, 18, '2026-02-25 13:33:28'),
(140, 68, 14, '2026-02-25 13:33:28'),
(141, 68, 12, '2026-02-25 13:33:28'),
(142, 68, 17, '2026-02-25 13:33:28'),
(143, 68, 20, '2026-02-25 13:33:28'),
(144, 68, 16, '2026-02-25 13:33:28'),
(145, 68, 4, '2026-02-25 13:33:28'),
(146, 68, 19, '2026-02-25 13:33:28'),
(147, 68, 7, '2026-02-25 13:33:28'),
(148, 68, 15, '2026-02-25 13:33:28'),
(149, 68, 13, '2026-02-25 13:33:28'),
(150, 69, 3, '2026-02-25 13:38:04'),
(151, 69, 18, '2026-02-25 13:38:04'),
(152, 69, 14, '2026-02-25 13:38:04'),
(153, 69, 12, '2026-02-25 13:38:04'),
(154, 69, 17, '2026-02-25 13:38:04'),
(155, 69, 20, '2026-02-25 13:38:04'),
(156, 69, 16, '2026-02-25 13:38:04'),
(157, 69, 4, '2026-02-25 13:38:04'),
(158, 69, 19, '2026-02-25 13:38:04'),
(159, 69, 7, '2026-02-25 13:38:04'),
(160, 69, 15, '2026-02-25 13:38:04'),
(161, 69, 13, '2026-02-25 13:38:04'),
(162, 70, 3, '2026-02-25 13:39:46'),
(163, 70, 18, '2026-02-25 13:39:46'),
(164, 70, 14, '2026-02-25 13:39:46'),
(165, 70, 12, '2026-02-25 13:39:46'),
(166, 70, 17, '2026-02-25 13:39:46'),
(167, 70, 20, '2026-02-25 13:39:46'),
(168, 70, 16, '2026-02-25 13:39:46'),
(169, 70, 4, '2026-02-25 13:39:46'),
(170, 70, 19, '2026-02-25 13:39:46'),
(171, 70, 7, '2026-02-25 13:39:46'),
(172, 70, 15, '2026-02-25 13:39:46'),
(173, 70, 13, '2026-02-25 13:39:46'),
(174, 71, 12, '2026-02-25 13:42:07'),
(175, 71, 17, '2026-02-25 13:42:07'),
(176, 71, 20, '2026-02-25 13:42:07');
...
INSERT INTO `system_settings` (`setting_key`, `setting_value`, `updated_at`, `group_name`) VALUES
('ai_api_key', '', '2026-01-06 06:38:49', 'general'),
('ai_enabled', 'false', '2026-01-06 06:38:49', 'general'),
('allowed_file_types', 'pdf,doc,docx,xls,xlsx,jpg,jpeg,png', '2026-01-06 06:38:49', 'general'),
('auto_lock_screen', '1', '2026-02-10 07:38:40', 'general'),
('contact_email', 'admin@lgu.gov.ph', '2026-01-06 15:59:33', 'general'),
('copyright_text', '© 2025 Legislative Agenda & Content System (LACS). City Government of Valenzuela.', '2026-02-10 07:38:40', 'general'),
('date_format', 'MM/DD/YYYY', '2026-01-06 06:38:49', 'general'),
('debug_mode', 'false', '2026-01-06 06:38:49', 'general'),
('description', '', '2026-02-10 07:08:36', 'general'),
('detailed_errors', 'false', '2026-01-06 06:38:49', 'general'),
('enable_ai', 'true', '2026-01-06 06:38:49', 'general'),
('enable_calendar_export', 'true', '2026-01-06 06:38:49', 'general'),
('enable_email_notifications', 'true', '2026-01-06 06:38:49', 'general'),
('enable_public_portal', 'true', '2026-01-06 06:38:49', 'general'),
('ical_enabled', 'true', '2026-01-06 06:38:49', 'general'),
('ical_url', '', '2026-01-06 06:38:49', 'general'),
('lockout_duration', '5', '2026-02-25 13:19:00', 'general'),
('logo_path', 'images/logo.png', '2026-01-06 06:38:49', 'general'),
('log_retention_days', '365', '2026-02-10 07:38:40', 'general'),
('maintenance_message', 'System is currently under maintenance. Please check back later.', '2026-01-06 06:38:49', 'general'),
('maintenance_mode', 'true', '2026-01-19 07:47:48', 'general'),
('max_file_size', '10', '2026-01-06 06:38:49', 'general'),
('max_login_attempts', '5', '2026-02-10 07:38:40', 'general'),
('max_upload_size', '5', '2026-01-02 04:47:16', 'general'),
('notification_email', 'true', '2026-01-06 06:38:49', 'general'),
('notification_enabled', 'true', '2026-01-06 06:38:49', 'general'),
('notification_in_app', 'true', '2026-01-06 06:38:49', 'general'),
('org_name', '', '2026-02-10 07:08:36', 'general'),
('password_complexity', 'High', '2026-02-10 07:38:40', 'general'),
('password_expiry_days', '90', '2026-02-10 07:38:40', 'general'),
('primary_color', '#DC2626', '2026-01-06 06:38:49', 'general'),
('reminder_agenda', 'true', '2026-01-06 06:38:49', 'general'),
('reminder_deadline', 'true', '2026-01-06 06:38:49', 'general'),
('reminder_deadline_days', '3,1', '2026-01-06 06:38:49', 'general'),
('reminder_errors', 'true', '2026-01-06 06:38:49', 'general'),
('reminder_session', 'true', '2026-01-06 06:38:49', 'general'),
('reminder_session_days', '7,3,1', '2026-01-06 06:38:49', 'general'),
('secondary_color', '#FFFFFF', '2026-01-06 06:38:49', 'general'),
('session_timeout', '30', '2026-02-25 13:19:00', 'general'),
('site_description', 'Official Legislative Automation and Content System', '2026-01-06 15:59:33', 'general'),
('site_name', 'LGU Legislative Management', '2026-01-06 15:59:33', 'general'),
('smtp_encryption', 'tls', '2026-01-06 06:38:49', 'general'),
('smtp_from_email', 'lacsspval@gmail.com', '2026-02-24 06:48:26', 'general'),
('smtp_from_name', 'LACS-SPVALENZUELA', '2026-02-24 06:48:26', 'general'),
('smtp_host', 'smtp.gmail.com', '2026-01-06 06:38:49', 'general'),
('smtp_password', 'nweh buko kixu jref', '2026-02-24 06:48:26', 'general'),
('smtp_port', '587', '2026-01-06 06:38:49', 'general'),
('smtp_username', 'lacsspval@gmail.com', '2026-02-24 06:48:26', 'general'),
('storage_limit', '53687091200', '2026-01-06 06:38:49', 'general'),
('storage_used', '0', '2026-01-06 06:38:49', 'general'),
('support_email', 'support@lgu.valenzuela.gov.ph', '2026-02-10 07:38:40', 'general'),
('system_language', 'English', '2026-02-10 07:38:40', 'general'),
('system_logo_url', '', '2026-02-10 07:38:40', 'general'),
('system_name', '', '2026-02-10 07:08:36', 'general'),
('system_timezone', 'Asia/Manila', '2026-02-10 07:43:48', 'general'),
('system_version', '1.0.0', '2026-01-06 06:38:49', 'general'),
('theme_color', 'red', '2026-01-02 04:47:16', 'general'),
('timezone', 'Asia/Manila', '2026-01-06 06:38:49', 'general');
...
CREATE TABLE `users` (
  ...
  `user_role` enum('User','Staff','Administrator') NOT NULL,
...
(1, 'lacsspval@gmail.com', 'adminspval@lgu.gov.ph', '$2y$12$L9tGy9ufWS6K3m.ztn3cJOcanS9MarEocoQfWNQWvseZW0oZSZ4Iy', 'SP Admin', 'Administrator', NULL, '2026-02-25 15:05:42', 'Active', 0, NULL),
...
INSERT INTO `user_notes` (`note_id`, `user_id`, `note_date`, `note`, `created_at`, `updated_at`) VALUES
(5, 4, '2026-01-16', 'mamamo', '2026-01-16 13:09:54', NULL);
...
(19, 11, '522371', '2026-02-10 19:05:36', 0, '2026-02-10 11:00:36'),
