# LACS - Capstone Template

## Overview
This is a **fully functional standalone version** of the Legislative Agenda and Calendar System (LACS) built with pure **HTML, CSS, and JavaScript**. It replicates all the core features of the PHP-based LACS without requiring a backend server or database.
...
| Feature | LACS (PHP) | Capstone Template |
|---------|------------------|-------------------|
| Dashboard | ✅ | ✅ |
| Document Management | ✅ | ✅ |
| Advanced Search | ✅ | ✅ |
...
**Based on**: LACS (Legislative Agenda and Calendar System)  
